...
Алгоритм создания G-Code для станков с ЧПУ из среды `_RHINOCEROS_3D_`. Референсом послужило растровое изображение - фотография _.jpg_.
